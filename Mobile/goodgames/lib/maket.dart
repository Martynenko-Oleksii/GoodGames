...
import '../getdata.dart';
import 'competitions/competition_enter.dart';
import 'competitions/competition_shedule.dart';

class macet extends StatefulWidget {
  final Competition comp;

  @override
  _macetState createState() => _macetState();

  macet({Key? key, required this.comp}) : super(key: key);
}

class _macetState extends State<macet> with SingleTickerProviderStateMixin {
