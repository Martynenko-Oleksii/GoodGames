...
class _ProfileState extends State<ProfileScreen>
  ...
  @override
  void initState() {
    if (widget.user.sports != null) profileList = widget.user.sports!;
      ...
      subState = new Text(
        "діє до: " +
            DateFormat('yyyy-MM-dd – kk:mm')
                .format(widget.user.subscription!.end!) +
            " lvl: " +
            widget.user.subscription!.lvl.toString(),
        style: TextStyle(
          fontSize: 14,
          color: AppTheme.darkText,
          fontWeight: FontWeight.w700,
                            ...
                            child: new Row(children: <Widget>[
                              new Container(
                                ...
                                child: CircleAvatar(
                                  ...
                                  child: Container(
                                    margin:
                                        EdgeInsets.only(left: 33.0, top: 33),
                                    child: IconButton(
                                      icon: const Icon(
                                        Icons.edit_outlined,
                                        color: Colors.black,
  ...
  void callback(listData) {
    getDatahttp
        .deleteFavouriteSport(widget.user.id!, listData.id)
        .then((value) {
      setState(() {
        widget.user.sports = value;
